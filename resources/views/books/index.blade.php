...
@section('content')
    ...
    <form action="{{ route('books.index') }}" method="GET" class="mb-4 flex items-center space-x-2 ">
        {{-- old value if it was sent before use request store previous value --}}
    ...
    <div class="filter-container mb-4 flex">
        ...
        @endphp
        {{-- spread opetator = ...request()->query() all array the query parameters --}}
    ...
    <ul>
        @forelse($books as $book)
            <li class="mb-4">
                <div class="book-item">
                    <div class="flex fl ex-wrap items-center justify-between">
        ...
        <li class="mb-4">
            <div class="empty-book-item">
                ...
                <a href="{{ route('books.index') }}" class="reset-link">Reset Crtieria</a>
            </div>
        </li>
        @endforelse
    </ul>
